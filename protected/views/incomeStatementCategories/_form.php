...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<?php
			//var_dump(IncomeStatementCategories::model()->findAll()->getAttributes());
	...
	<div class="row">
		<?php
			...
			echo $form->dropDownList(
						...
						$list, 
						array(
							'options'=>array(IncomeStatementCategories::model()->find("id={$_GET['p']}")->getAttribute('parent_id')=>array('selected'=>true,'readonly'=>true))
						)
				);
		?>
	</div>
