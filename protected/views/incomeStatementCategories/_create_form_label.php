...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<?php
		...
		$bs_model=new IncomeStatementCategories;
	...
	<div class="row">
		...
		<?php echo $form->dropDownList($bs_model,'is_added',array('1' => 'Add',
			 '1'=>'Less',
		)); ?>
	...
	<div class="row nolabel buttons">
		<?php 
			echo CHtml::ajaxSubmitButton($model->isNewRecord ? 'Add' : 'Save', 
		         CHtml::normalizeUrl(array('IncomeStatementCategories/create')), 
		         array(
